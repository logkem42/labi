...
$services -> Setnazvanie('Лабораторные работы по предмету Динамические веб-системы в экономике <br> Студента группы ПИс-161: Бардиера Висилия Васильевича <br> Проверил: к.т.н. доц. Назимов А.С.');
